...
(function(IW) { 
     ...
     */ 
    PasswordValidator.prototype.passwordAttemptsPerSecond = 15000; 
...
(function(IW, jQuery) { 
    ...
    jQuery.fn.passwordValidate = function() { 
        ...
        this 
                ...
                .after("<div class='passwordStrengthLabel'><?php echo __d('z', 'Password strength: '); ?>" +
		"<div class='passwordStrengthBar'>" + 
                "<div></div>" + 
                "</div></div>"); 
...
jQuery("input[id='AccountPasswordPassword']").passwordValidate();
